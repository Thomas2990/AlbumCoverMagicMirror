...
const fs = require('fs');
const js = require('json-stringify-safe');
 ...
 */
  ...
  var config = JSON.stringify(jsonVar);
  fs.writeFile('modules/MMM-NowPlayingOnSpotify/spotifyConfig.json', config, 'utf-8', function(err, data){});
